#Takes in ASE_pval data and finds the qvalues, outputs to qval.txt
#Must use consolidate.py script to add qval column to the file
#Usage: python qvalue_script.py ASE_pval_input.txt qval.txt 
...
qvalues = open(sys.argv[2],"w")
#qval_output = open(sys.argv[3],"w")
...
##        qval_output.write(chrom1 + "\t" + pos1 + "\t" + ref1 + "\t" + str(count1) +"\t" + first1 + "\t" + second1 + "\t" + str(chi21) + "\t" + str(pval1) + "\t" + qv + "\n")
##        
print "Complete"
